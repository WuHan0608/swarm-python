...
class StartContainer(Containers):
    ...
    """
    def __init__(self, base_url, version=None):
        super(StartContainer, self).__init__(base_url, version)
...
class StopContainer(Containers):
    ...
    """
    def __init__(self, base_url, version=None):
        super(StopContainer, self).__init__(base_url, version)
...
class RestartContainer(Containers):
    ...
    """
    def __init__(self, base_url, version=None):
        super(RestartContainer, self).__init__(base_url, version)
...
class RemoveContainer(Containers):
    ...
    """
    def __init__(self, base_url, version=None):
        super(RemoveContainer, self).__init__(base_url, version)
