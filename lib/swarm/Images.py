...
class Images(object):
    ...
    def __init__(self, base_url, version):
        ...
        self.repo_length = 0     # repo field length
        self.tag_length = 0      # tag field length
...
class Tag(Images):
    ...
    """
    def __init__(self, base_url, version):
        super(Tag, self).__init__(base_url, version)
...
class RemoveImage(Images):
    ...
    """
    def __init__(self, base_url, version):
        super(RemoveImage, self).__init__(base_url, version)
